...
QString MainWindow::shortcutsHelpHtml()
{
    ...
    return QStringLiteral(
        ...
        "<tr><td><kbd>Ctrl+A</kbd> / <kbd>Ctrl+Shift+A</kbd></td><td>全选 / 取消全选画廊图片</td></tr>"
        ...
        "<tr><td><kbd>Ctrl+滚轮</kbd> / <kbd>Ctrl++</kbd> / <kbd>Ctrl+-</kbd></td><td>调整缩略图大小（<kbd>Ctrl+0</kbd> 重置）</td></tr>"
        ...
        "放大 / 缩小</td></tr>"
        "<tr><td><kbd>0</kbd> / <kbd>1</kbd> / <kbd>2</kbd></td><td>适应窗口 / 实际大小(100%) / 200%</td></tr>"
