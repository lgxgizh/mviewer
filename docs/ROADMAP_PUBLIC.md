...
## Where we are now — **Beta / 1.0.26 Compare chrome**

MViewer remains in **Beta** on the post-`v1.0.10` hardening line, now verified as
the `1.0.26` patch line. The product
...
| --- | --- | --- |
| **1.0.26** (current line) | Compare safe insets, ROI A/B tags, readable PSNR | 🔵 Beta hardening |
...
The repository verifies the `v1.0.26` patch line. The remaining 1.0 work is
