...
## Where we are now — **Beta / 1.0.16 color-managed presentation (M59)**

MViewer remains in **Beta** on the post-`v1.0.10` hardening line, now released as
  the `1.0.16` patch line. The product
...
| --- | --- | --- |
| **1.0.16** (current line) | Color-managed presentation, canonical ICC/EXIF metadata, monitor-target invalidation, and Browse regression closure | 🔵 Beta hardening |
...
The repository verifies the `v1.0.16` patch line. The remaining 1.0 work is
