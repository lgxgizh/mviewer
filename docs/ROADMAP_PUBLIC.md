...
## Where we are now — **Beta / 1.0.29 Compare filenames**

MViewer remains in **Beta** on the post-`v1.0.10` hardening line, now verified as
the `1.0.29` patch line. The product
...
| --- | --- | --- |
| **1.0.29** (current line) | Larger Compare filenames | 🔵 Beta hardening |
...
The repository verifies the `v1.0.29` patch line. The remaining 1.0 work is
