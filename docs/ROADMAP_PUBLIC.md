...
| --- | --- | --- |
| **1.0.28** (current line) | User guide and P to open Compare | 🔵 Beta hardening |
...
The repository verifies the `v1.0.28` patch line. The remaining 1.0 work is
