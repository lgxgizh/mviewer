...
*(Note: `thumbnailpanel_delegates.cpp::paint` [span 202 / CC 32] and `core/batch/BatchProcessor.cpp::processFile` [span 130] were split into modular helpers in 2026-09 and removed from this inventory).*
