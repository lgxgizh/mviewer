...
| [017](017-process-lifetime-services.md) | 进程级服务故意不析构；对象级析构必须成立 | 区分"平台退出限制"与"忘记析构"，并由 stress 测试守住后者 |
...
| ADR | 决策 | 一句话理由 |
|---|---|---|
| [ADR-015](ADR-015-quality-automation.md) | 质量信号由 CI 自动生成并回写（M23） | 手工维护的 dashboard / 测试矩阵必然腐化 |
